 ...
 * @since 2020-08-14
 */
@ApiModel(value="WyDutyManage对象", description="执勤管理")
public class WyDutyManage implements Serializable {
    ...
    @ApiModelProperty(value = "执勤日期")
    private LocalDateTime dutyDate;

    @ApiModelProperty(value = "执勤人")
    private String dutyPerson;

    @ApiModelProperty(value = "执勤类型")
    private String dutyType;

    @ApiModelProperty(value = "执勤地点")
    private String dutyPlace;

    @ApiModelProperty(value = "执勤记录")
