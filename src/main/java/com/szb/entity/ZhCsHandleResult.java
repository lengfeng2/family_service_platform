 ...
 * @since 2020-08-14
 */
@ApiModel(value="ZhCsHandleResult对象", description="业主服务_办理结果")
public class ZhCsHandleResult implements Serializable {
    ...
    @ApiModelProperty(value = "所属服务单id")
