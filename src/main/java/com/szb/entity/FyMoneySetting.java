 ...
 * @since 2020-08-14
 */
@ApiModel(value="FyMoneySetting对象", description="费项设置")
public class FyMoneySetting implements Serializable {
    ...
    @ApiModelProperty(value = "是否允许修改单价")
    private String isUpdatePrice;

    @ApiModelProperty(value = "是否便捷费项")
    private String isConvenientMoney;

    @ApiModelProperty(value = "最小使用量")
    private Double minUsedNumber;

    @ApiModelProperty(value = "是否阶梯收费")
    private String isStepReceive;

    @ApiModelProperty(value = "阶梯条件1")
    private Double stepCondition1;

    @ApiModelProperty(value = "阶梯单价1")
    private Double stepPrice1;

    @ApiModelProperty(value = "阶梯条件2")
    private Double stepCondition21;

    @ApiModelProperty(value = "阶梯条件2")
    private Double stepCondition22;

    @ApiModelProperty(value = "阶梯单价2")
    private Double stepPrice2;

    @ApiModelProperty(value = "阶梯条件3")
    private Double stepCondition31;

    @ApiModelProperty(value = "阶梯条件3")
    private Double stepCondition32;

    @ApiModelProperty(value = "阶梯单价3")
    private Double stepPrice3;

    @ApiModelProperty(value = "阶梯条件4")
    private Double stepCondition41;

    @ApiModelProperty(value = "阶梯条件4")
    private Double stepCondition42;

    @ApiModelProperty(value = "阶梯单价4")
    private Double stepPrice4;

    @ApiModelProperty(value = "阶梯条件5")
    private Double stepCondition5;

    @ApiModelProperty(value = "阶梯单价5")
    private Double stepPrice5;

    @ApiModelProperty(value = "续费短信")
    private String renewMessage;

    @ApiModelProperty(value = "从已收费的费用止期后N天发送短信")
    private Integer receiveWarnStopDay;

    @ApiModelProperty(value = "最多短信重复提醒次数")
    private Integer maxWarnNumber;

    @ApiModelProperty(value = "催缴短信")
    private String askMessage;

    @ApiModelProperty(value = "从未收取的缴费限期前N天发送短信")
    private Integer noReceiveWarnStopDay;

    @ApiModelProperty(value = "关联费项ID")
    private Integer associateMoneyId;

    @ApiModelProperty(value = "滞纳金比率")
    private Double delayRate;

    @ApiModelProperty(value = "滞纳金超期天数")
    private Integer delayOverDay;

    @ApiModelProperty(value = "所属公司")
    private String company;

    @ApiModelProperty(value = "常规收费打印时隐藏单价")
