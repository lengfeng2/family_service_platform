 ...
 * @since 2020-08-14
 */
@ApiModel(value="ZhCustomerCheck对象", description="业主验房")
public class ZhCustomerCheck implements Serializable {
    ...
    @ApiModelProperty(value = "业主意见")
    private String consumerAdvice;

    @ApiModelProperty(value = "房管员意见")
